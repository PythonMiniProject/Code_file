...
def log_in():
        ...
        for adhar_check in all_accounts:
            if adhar_check == login_adharcard:
                ...
                def user_details():
                    ...
                    Label(showvalues, text="Phone No: *******" + phoneInStars[7] + phoneInStars[8] + phoneInStars[9],
                          font='Calibri 20', ).place(x=44, y=140)
                    Label(showvalues,
                          text="Aadhar No: *********" + aadharInStars[9] + aadharInStars[10] + aadharInStars[11],
    ...
    entry_admin_lbl_id = Entry(admin_frame, bd=5, textvariable=temp_admin_id, relief=SUNKEN,
                               font="Lucida 20 bold").grid(row=3, column=1, padx=7,
                                                           pady=4)
    ...
    admin_button_login = Button(admin_frame, image=admin_login_button, command=admin_login, borderwidth=0,
                                background="white")
